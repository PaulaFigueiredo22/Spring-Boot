...
import com.Farmacia.dez.repository.CamadaRepository;
...
public class CategoriaController {
	...
	@Autowired
	private CamadaRepository repositoty;
	...
	return ResponseEntity.ok(repositoty.findAllByDescricaoContainIgnoreCase(descricao));	
	}
