package org.generaction.blogPessoal.controller;

import java.util.List;

import org.generaction.blogPessoal.model.Postagem;
import org.generaction.blogPessoal.repository.PostagemRepository;
...
public class PostagemController {
	...
	@PostMapping 
		...
		return ResponseEntity.status(HttpStatus.ACCEPTED).body(repositoty.save(postagem));	
	}
